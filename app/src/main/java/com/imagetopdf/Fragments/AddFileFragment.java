package com.imagetopdf.Fragments;
...
import com.imagetopdf.Adapters.ImageAdapter;
import com.imagetopdf.BuildConfig;
...
public class    AddFileFragment extends Fragment implements OnChangePic, Visibility {
    ...
    private void openPdf(String filename) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
            path = FileProvider.getUriForFile(context, "com.imagetopdf.Utils.FileProvider", file);
        else
